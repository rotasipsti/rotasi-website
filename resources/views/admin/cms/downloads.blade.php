    ...
    <div x-show="showAddModal" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-0" style="display: none;">
        ...
        <div x-show="showAddModal" x-transition.scale.95 class="bg-card text-card-foreground rounded-xl border shadow-lg w-full max-w-lg z-50 overflow-hidden relative">
            <div class="flex justify-between items-center p-6 border-b">
                <h3 class="font-bold text-lg">Tambah Dokumen Baru</h3>
            ...
            <form action="{{ route('admin.cms.download.store') }}" method="POST">
                ...
                <div class="p-6 space-y-4">
                    <div>
                        <label class="block text-sm font-medium mb-1">Judul Dokumen <span class="text-destructive">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-1">URL File (Link GDrive / Dropbox) <span class="text-destructive">*</span></label>
                ...
                <div class="p-6 border-t bg-muted/50 flex justify-end gap-2">
                    ...
                    <button type="submit" class="bg-primary text-primary-foreground hover:bg-primary/90 px-4 py-2 rounded-md text-sm font-medium">Simpan Dokumen</button>
                </div>
            </form>
        </div>
    </div>
