        ...
        <div class="rounded-xl border border-border/50 bg-card text-card-foreground shadow">
            <div class="flex flex-col space-y-1.5 p-6 text-center">
                <h3 class="font-semibold leading-none tracking-tight text-2xl flex items-center justify-center gap-2">
                    ...
                    Login Divisi Keamanan
                </h3>
                <p class="text-sm text-muted-foreground">
                    Silakan masuk ke akun divisi keamanan Anda
                </p>
            </div>
            <div class="p-6 pt-0">
                <form method="POST" action="{{ route('login') }}" class="mt-6">
                    ...
                    <div class="space-y-4">
                        ...
                        <div x-data="{ showPassword: false }">
                            <label for="password" class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">Password Login</label>
                    ...
                    <div class="mt-4 text-center text-sm">
                        Belum punya akun? 
                        <a href="{{ route('register.keamanan') }}" class="text-primary hover:underline">Daftar disini</a>
                    </div>
                </form>
            </div>
        </div>
