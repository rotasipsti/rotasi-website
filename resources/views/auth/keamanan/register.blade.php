        ...
        <div class="rounded-xl border border-border/50 bg-card text-card-foreground shadow">
            <div class="flex flex-col space-y-1.5 p-6 text-center">
                <h3 class="font-semibold leading-none tracking-tight text-2xl flex items-center justify-center gap-2">
                    ...
                    Daftar Divisi Keamanan ROTASI
                </h3>
                <p class="text-sm text-muted-foreground">
                    Lengkapi data untuk mendaftar sebagai divisi keamanan
                </p>
            </div>
            <div class="p-6 pt-0">
                <form method="POST" action="{{ route('register') }}" class="mt-6">
                    @csrf
                    <input type="hidden" name="userType" value="keamanan">
                    ...
                    <div class="mt-4 text-center text-sm">
                        Sudah punya akun? 
                        <a href="{{ route('login.keamanan') }}" class="text-primary hover:underline">Login disini</a>
                    </div>
                </form>
            </div>
        </div>
